module.exports = nativeDescription: "日本語", englishDescription: "Japanese", translation:
  ...
  new_home:
    ...
    forgot_learning: "学んだことは実際忘れてしまうと思う。"
    wanted_to_do: " コーディングはずっとしてきたが、私は決して学校で習おうとは思わない。"
    why_games: "なぜゲームを通して習うのが大切か？"
    games_reward: "ゲームは、生産に取り組むことで酬いてくれる。"
    encourage: "ゲームすることは普通だ。 それは、インタラクション、発見と試行錯誤を促します。良いゲームはプレーヤーに時間とともに技術に熟達するよう要求します。そして、それは彼らが学ぶのと同じ学生が経験する危機的なプロセスです。"
